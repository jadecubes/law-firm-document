  ...
  apisidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          id: "admin-api/provision-a-user-identity-profile-roles-optional-credentials",
          label: "Provision a user (identity + profile + roles + optional credentials)",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "admin-api/list-professional-credentials-for-a-user",
          label: "List professional credentials for a user",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "admin-api/add-a-professional-credential-to-a-user",
          label: "Add a professional credential to a user",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "admin-api/remove-a-professional-credential-from-a-user",
          label: "Remove a professional credential from a user",
          className: "api-method delete",
        },
        {
          type: "doc",
          id: "admin-api/list-user-profiles-in-a-firm-filterable-by-role-credential",
          label: "List user profiles in a firm (filterable by role/credential)",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "admin-api/deprecated-list-lawyers-in-a-firm",
          label: "(Deprecated) List lawyers in a firm",
          className: "menu__list-item--deprecated api-method get",
        },
        {
          type: "doc",
          id: "admin-api/deprecated-provision-a-lawyer-use-post-users",
          label: "(Deprecated) Provision a lawyer (use POST /users)",
          className: "menu__list-item--deprecated api-method post",
        },
        {
          type: "doc",
          id: "admin-api/deprecated-provision-a-staff-member-use-post-users",
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          id: "admin-api/list-support-access-sessions",
        ...
        {
          type: "doc",
          id: "admin-api/acquire-an-exclusive-admin-lock-on-a-resource",
          label: "Acquire an exclusive admin lock on a resource",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "admin-api/release-a-lock",
